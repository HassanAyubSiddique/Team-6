...
function addBatch(raw_material_id) {
    window.location.href = "add_batch_raw_material.php?raw_material_id=" + raw_material_id;
}

function useRawMaterials(raw_material_id) {
    window.location.href = "use_raw_materials.php?raw_material_id=" + raw_material_id;
}
