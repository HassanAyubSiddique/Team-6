...
class AdminManagement {
    ...
    public function retrieveAdminProfile($admin_id, &$firstName, &$lastName, &$email, &$phoneNumber, &$address, &$city, &$country, &$postcode) {
    ...
    public function updateAdminProfile($admin_id, $firstName, $lastName, $phoneNumber, $address, $city, $country, $postcode) {
    ...
    public function changePassword($admin_id, $oldPassword, $newPassword, $confirmPassword) {
        // Validate passwords
