...
// Assuming your JSON file is named 'products.json'
fetch('./data/products.json')
  ...
  .then(data => {
    data.forEach(product => {
      ...
      // Assuming your product object has properties like name, description, and image
...
// Assuming you have a form with the ID 'add-product-form' in add_product.html
const addProductForm = document.getElementById('add-product-form');

addProductForm.addEventListener('submit', (event) => {
  event.preventDefault(); // Prevent default form submission behavior

  const formData = new FormData(addProductForm); // Get form data

  // Assuming your server-side script expects data in a specific format,
  // modify the request here (e.g., using fetch API or another library)
  fetch('/add-product', {
    method: 'POST',
    body: formData,
  })
  .then(response => {
    if (response.ok) {
      // Handle successful product addition (e.g., clear form, display success message)
