...
$adminManagement->retrieveAdminProfile(8, $firstName, $lastName, $email, $phoneNumber, $address, $city, $country, $postcode);
...
<div class="profile-section">
  ...
  <form id="updateForm" method="POST" action="php/edit_admin_profile.php">
    <div class="profile-info">
      ...
      <input type="hidden" name="admin_id" value="8"> <!-- Assuming admin_id is fixed for the logged-in admin -->
    </div>
